...
<div class="d-flex">
    ...
    <div class="flex-grow-1 main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold text-dark mb-0">Manajemen Kategori</h2>
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-3"><span class="badge bg-info bg-opacity-10 text-info px-3 py-1 rounded-pill">{{ $category->products_count }} Menu</span></td>
                            <td class="text-end px-4 py-3">
                                <button class="btn btn-sm btn-light text-primary me-2 rounded-circle" data-bs-toggle="modal" data-bs-target="#editModal{{ $category->id }}" title="Edit">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div class="modal-body p-4">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Nama Kategori</label>
                        <input type="text" name="name" class="form-control" placeholder="Contoh: Minuman Dingin" required>
                    </div>
                </div>
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-light rounded-pill" data-bs-dismiss="modal">Batal</button>
